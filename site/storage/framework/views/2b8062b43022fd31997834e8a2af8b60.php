            ...
            <div class="event-link">
                <div class="event-card">
                    <div class="event-details">
                        ...
                        <div class="buttons">
                            <!-- Botones -->
                            <a href="<?php echo e(route('detalls-esdeveniment', ['id' => $sessio->esdeveniment->id])); ?>" title="Mostrar detalles del evento">
                            ...
                            <a href="<?php echo e(route('administrar-esdeveniment', ['id' => $sessio->esdeveniment->id])); ?>" title="Administrar el evento">
                                <svg xmlns="http://www.w3.org/2000/svg" height="24" width="24"
                            ...
                            <a href="<?php echo e(route('llistats-entrades', ['id' => $sessio->id])); ?>" title="Ver listados de entradas">
                                <svg xmlns="http://www.w3.org/2000/svg" height="24" width="24"
                                    viewBox="0 0 512 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                                    <path
